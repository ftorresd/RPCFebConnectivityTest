...
FebThresholdScan::FebThresholdScan(hwd::System & _system
...
hwd::DeviceType & FebThresholdScan::registerDeviceType(hwd::System & _system)
{
    ...
    hwd::DeviceType & _febthresholdscantype
        = _system.registerDeviceType("FebThresholdScan");
    ...
    hwd::ParameterType const & _vth_min_type
        =  _system.registerParameterType("VThMin", hwd::DataType::integer_);
    _febthresholdscantype.registerParameter(_vth_min_type, 0, hwd::Parameter::is_property_);
    hwd::ParameterType const & _vth_n_steps_type
        =  _system.registerParameterType("VThNSteps", hwd::DataType::integer_);
    _febthresholdscantype.registerParameter(_vth_n_steps_type, 0, hwd::Parameter::is_property_);
    hwd::ParameterType const & _vth_step_size_type
        =  _system.registerParameterType("VThStepSize", hwd::DataType::integer_);
    ...
    hwd::ParameterType const & _active_vth_type
        =  _system.registerParameterType("ActiveVTh", hwd::DataType::integer_);
...
FebThresholdScan & FebThresholdScan::registerDevice(hwd::System & _system
                                                    , rpct::tools::RollSelection const &  _roll_selection
                                                    , rpct::tools::Time const & _count_duration
                                                    , unsigned int _vth_min, unsigned int _vth_n_steps, unsigned int _vth_step_size
                                                    , unsigned int _vmon
                                                    , bool _auto_correct
                                                    , bool _use_pulser
                                                    ...
                                                    , std::string const & _snapshot_name)
{
    ...
    hwd::StandaloneDeviceConfiguration _properties
        = _system.getHardwareStorage().registerDeviceTypeConfiguration(_system, _febthresholdscantype);
